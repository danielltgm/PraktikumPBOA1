 ...
 * Deskripsi   : Kelas Pengusaha merupakan turunan dari kelas Manusia
 *               dan mengimplementasikan interface Pajak.
 *               Kelas ini merepresentasikan data pengusaha beserta NPWP.
 * Pembuat     : Daniel Lamganda Tua Gultom
 * Tanggal     : 23 Maret 2026 - 05.19
 */
...
public class Pengusaha extends Manusia implements Pajak {
    ...
    // NIM = 24060124120048 (Digit ke-13 adalah 4)
    @Override
    public int hitungMasaKerja() {
        LocalDate sekarang = LocalDate.now();
        return sekarang.getYear() - this.tgl_mulai_kerja.getYear() + 4;
    }
